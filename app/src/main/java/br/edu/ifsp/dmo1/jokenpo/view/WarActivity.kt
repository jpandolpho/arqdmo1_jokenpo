...
import br.edu.ifsp.dmo1.jokenpo.databinding.ActivityWarBinding
import br.edu.ifsp.dmo1.jokenpo.model.Player
import br.edu.ifsp.dmo1.jokenpo.model.War
            ...
            if (result.resultCode == Activity.RESULT_OK) {
                ...
                if (extras != null) {
                    ...
                    val chosenWeapon: Weapon =
                        extras.getSerializable(Constants.KEY_WEAPON, Weapon::class.java) as Weapon
                    if (number == 1)
